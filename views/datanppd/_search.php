...
<div class="form-datakeberatan2016-search">
    ...
    <?php /* echo $form->field($model, 'jalur')->dropDownList([ 'Hijau' => 'Hijau', 'Kuning' => 'Kuning', 'Merah' => 'Merah', 'MITA' => 'MITA', 'Lainnya' => 'Lainnya', ], ['prompt' => '']) */ ?>
    ...
    <?php /* echo $form->field($model, 'jenispenetapan')->dropDownList([ 'Tarif' => 'Tarif', 'Nilai Pabean' => 'Nilai Pabean', 'Tarif & Nilai Pabean' => 'Tarif & Nilai Pabean', 'Audit' => 'Audit', 'Sanksi Adm(SPSA' => 'Sanksi Adm(SPSA', ], ['prompt' => '']) */ ?>

    <?php /* echo $form->field($model, 'hasilkeputusan')->dropDownList([ 'Tolak' => 'Tolak', 'Terima' => 'Terima', 'Tolak Formal' => 'Tolak Formal', 'Terima Sebagian' => 'Terima Sebagian', ], ['prompt' => '']) */ ?>
    ...
    <?php /* echo $form->field($model, 'noagendakantor')->textInput(['maxlength' => true, 'placeholder' => 'Noagendakantor']) */ ?>

    <?php /* echo $form->field($model, 'tglagenda')->widget(\kartik\datecontrol\DateControl::classname(), [
        'type' => \kartik\datecontrol\DateControl::FORMAT_DATE,
        'saveFormat' => 'php:Y-m-d',
        'ajaxConversion' => true,
        'options' => [
    ...
    <?php /* echo $form->field($model, 'idnoagenda')->textInput(['maxlength' => true, 'placeholder' => 'Idnoagenda']) */ ?>

    <?php /* echo $form->field($model, 'formalterbit')->dropDownList([ 'terpenuhi' => 'Terpenuhi', 'tidak terpenuhi' => 'Tidak terpenuhi', '' => '', ], ['prompt' => '']) */ ?>

    <?php /* echo $form->field($model, 'formalaju')->dropDownList([ 'terpenuhi' => 'Terpenuhi', 'tidak terpenuhi' => 'Tidak terpenuhi', '' => '', ], ['prompt' => '']) */ ?>

    <?php /* echo $form->field($model, 'mslh')->textInput(['maxlength' => true, 'placeholder' => 'Mslh']) */ ?>

    <?php /* echo $form->field($model, 'teliti')->textInput(['maxlength' => true, 'placeholder' => 'Teliti']) */ ?>

    <?php /* echo $form->field($model, 'pendpt')->textInput(['maxlength' => true, 'placeholder' => 'Pendpt']) */ ?>

    <?php /* echo $form->field($model, 'bm')->textInput(['placeholder' => 'Bm']) */ ?>

    <?php /* echo $form->field($model, 'bm_t')->textInput(['placeholder' => 'Bm T']) */ ?>

    <?php /* echo $form->field($model, 'cukai')->textInput(['placeholder' => 'Cukai']) */ ?>

    <?php /* echo $form->field($model, 'cukai_t')->textInput(['placeholder' => 'Cukai T']) */ ?>

    <?php /* echo $form->field($model, 'ppn')->textInput(['placeholder' => 'Ppn']) */ ?>

    <?php /* echo $form->field($model, 'ppn_t')->textInput(['placeholder' => 'Ppn T']) */ ?>

    <?php /* echo $form->field($model, 'ppnbm')->textInput(['placeholder' => 'Ppnbm']) */ ?>

    <?php /* echo $form->field($model, 'ppnbm_t')->textInput(['placeholder' => 'Ppnbm T']) */ ?>

    <?php /* echo $form->field($model, 'pph')->textInput(['placeholder' => 'Pph']) */ ?>

    <?php /* echo $form->field($model, 'pph_t')->textInput(['placeholder' => 'Pph T']) */ ?>

    <?php /* echo $form->field($model, 'denda')->textInput(['placeholder' => 'Denda']) */ ?>

    <?php /* echo $form->field($model, 'denda_t')->textInput(['placeholder' => 'Denda T']) */ ?>

    <?php /* echo $form->field($model, 'berkasselesai')->checkbox() */ ?>

    <?php /* echo $form->field($model, 'idttmohon')->textInput(['maxlength' => true, 'placeholder' => 'Idttmohon']) */ ?>
