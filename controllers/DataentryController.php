...
/**
 * DataentryController implements the CRUD actions for Datakeberatan2016 model.
 */
class DataentryController extends Controller
{
    ...
    public function actionCetakdisposisi($id)
    {
     ...
     // die();
      ...
      //$ttpermohonan = Ttpermohonan::find()->where ('id = id',[':id '=> $id])->one(); 
       ...
       // Initalize the TBS instance
        ...
        $template = Yii::getAlias('@hscstudio/export').'/templates/opentbs/ttdisposisi.docx';
